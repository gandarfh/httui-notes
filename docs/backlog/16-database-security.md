...
- [x] Evaluate SQLite encryption (sqlcipher or PRAGMA key) — benchmark performance impact (deferred — see [`notes-db-encryption-future.md`](../notes-db-encryption-future.md))
