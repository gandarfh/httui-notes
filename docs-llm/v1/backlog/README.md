...
| 42 | [Connections refined UI](./42-connections-refined.md) | in progress (Stories 01-05 shipped at component level — commits 0f1fb06, 8ed373d, 3f70006, a4eaae5, d6a3698, 2688224; audit-031+032; carries: real enrichment + store loader + page mount + Story 06 + PK/FK row counts backend ext + vault-grep Tauri cmd) |
