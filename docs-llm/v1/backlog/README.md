...
| 42 | [Connections refined UI](./42-connections-refined.md) | in progress (Story 01 slices 1+2 + Story 02 shipped — commits 0f1fb06, 8ed373d, 3f70006; carries: real enrichment source + store loader + page mount point + Stories 03-06) |
