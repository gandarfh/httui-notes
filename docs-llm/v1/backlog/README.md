...
| 42 | [Connections refined UI](./42-connections-refined.md) | in progress (Story 01 slices 1+2 shipped — commits 0f1fb06, 8ed373d; carries: real enrichment source + store loader + page mount point) |
