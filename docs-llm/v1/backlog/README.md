...
| 42 | [Connections refined UI](./42-connections-refined.md) | in progress (Story 01 slice 1 shipped — commit 0f1fb06; carries: real list rows + per-kind counts + envs + selection cascade) |
