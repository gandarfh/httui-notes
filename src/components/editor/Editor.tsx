    ...
    <Box h="100%" overflow="hidden" display="flex" flexDirection="column">
      <Box
        ...
        css={{
          ...
          "& .tiptap pre code .hljs-keyword, & .tiptap pre code .hljs-selector-tag, & .tiptap pre code .hljs-built_in": {
            color: "var(--chakra-colors-purple-500)",
          },
          "& .tiptap pre code .hljs-string, & .tiptap pre code .hljs-attr": {
          ...
          "& .tiptap pre code .hljs-number, & .tiptap pre code .hljs-literal": {
            color: "var(--chakra-colors-orange-500)",
          },
          "& .tiptap pre code .hljs-title, & .tiptap pre code .hljs-section": {
            color: "var(--chakra-colors-blue-500)",
          },
          "& .tiptap pre code .hljs-type, & .tiptap pre code .hljs-name": {
            color: "var(--chakra-colors-teal-500)",
          },
          "& .tiptap pre code .hljs-variable, & .tiptap pre code .hljs-template-variable": {
          ...
          "& .tiptap .selectedCell": {
            bg: "var(--chakra-colors-blue-500/10)",
          },
        }}
      >
